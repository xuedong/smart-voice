...
% - Angles corresponding to each direction {theta, phi} for each microphone pair
% - Sampled angles array for each microphone pair
% - Corresponding TDOAs for each microphone pair
% This function depends only on the microphones positions and the search 
...
[Pjk_x, Pjk_y, Pjk_z] = sph2cart(thetaGrid*pi/180, phiGrid*pi/180, 1);
...
Pjk_All = repmat([Pjk_x;Pjk_y;Pjk_z],[1 1 nMicPair]);
